...
public class ProductInfoController {
	...
	///// Áp dụng cho cả 2 request POST and GET tới url	
	...
	public String showProductInfoList(Model model,HttpSession session , @ModelAttribute("searchForm") ProductInfo productInfo,@PathVariable("page") int page) {
		...
		model.addAttribute("titleCategory", "Product Information");
	...
	public String add(Model model) {
		model.addAttribute("titleCategory", "Add ProductInfo");
		model.addAttribute("modelForm", new ProductInfo());
		
		// Sử dung cho select box, Spring chỉ hỗ trợ Select Map or Hasmap
	...
	public String edit(Model model , @PathVariable("id") int id) {
		...
		if(productInfo!=null) {
			...
			model.addAttribute("mapCategory", mapCategory);
			model.addAttribute("titleCategory", "Edit ProductInfo");
	...
	public String view(Model model , @PathVariable("id") int id) {
		...
		ProductInfo productInfo = productService.findByIdProductInfo(id);
		if(productInfo!=null) {
			model.addAttribute("titleCategory", "View ProductInfo");
			model.addAttribute("modelForm", productInfo);
